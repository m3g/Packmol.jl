...
using LinearAlgebra: norm, eigen, dot, det, Diagonal, svd, cross
...
include("./constraints/gaussians.jl")
include("./constraints/waves.jl")
include("./constraints/exponentials.jl")
